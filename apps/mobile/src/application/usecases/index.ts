...
// Project UseCases
export const createProjectUseCase = new CreateProjectUseCase(projectRepository, genreRepository);
export const updateProjectUseCase = new UpdateProjectUseCase(projectRepository, genreRepository);
